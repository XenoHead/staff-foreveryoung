...
// ../.wrangler/tmp/bundle-xADVNx/checked-fetch.js
...
async function onRequestGet2(context) {
  try {
    ...
    if (type === "vendors") {
      ...
      `).all();
      return new Response(JSON.stringify({ success: true, vendors: results2.results.map((r) => r.Vendor) }), {
        status: 200,
        headers: { "Content-Type": "application/json" }
      });
    }
...
// ../.wrangler/tmp/pages-jQU1CQ/functionsRoutes-0.2583848939855252.mjs
var routes = [
  {
...
// ../../../Users/Scott/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../Users/Scott/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-xADVNx/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-xADVNx/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.41113093487662933.mjs.map
